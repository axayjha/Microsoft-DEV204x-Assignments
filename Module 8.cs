...
namespace Module8
{
    ...
    class MainClass
    {
        ...
        static void Main(string[] args)
        {
            ...
            /*
            * This code is built upon module 7 assignmet. So some leftovers exist: some extra classes            
            ...
            */
            ...
            // Adding three students to this Course object.
    ...
    class Student : Person
    {
        ...
        {
            Console.WriteLine("Grades for {0} (Sem-wise; latest on top): \n", this.Name);
            foreach (int point in this.Grades)
            {
    ...
    class Course
    {
        ...
        //Student ArrayList replaced with a List<T>
        ...
        // The objects inside the foreach loop doesn't need to be explicitly type-casted to Student now on.

        public void ListStudents()
        {
            Console.WriteLine("List of students in the course '{0}' \n", this.Name);
            foreach (Student member in this.students)
            {
    ...
    /*---------------------------------------------------
    *The classes below are same as in Module 7 Assignment
    *No changes to them
    *----------------------------------------------------*/
